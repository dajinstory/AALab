...
package com.scream_tracking.dajin.etri_pj_v1.libsvm;
import java.io.*;
import java.util.*;
...
public class svm {
	...
	public static svm_model svm_load_model(InputStreamReader stream) throws IOException
	{
		return svm_load_model(new BufferedReader(stream));
	}
	...
	public static svm_model svm_load_model(BufferedReader fp) throws IOException
	{
		...
		for(int i=0;i<l;i++)
		{
			...
			//	System.out.println("model = " + model.SV[i][j].index);
			}
		}
